...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newMenuModalLabel">Add New Menu</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newMenuModalLabel">Adding New Some Menu ..</h5>
            ...
            <form action="<?= base_url('menu') ?>" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control border-primary" name="menu" id="menu" placeholder="Menu Name..">
                    </div>
                </div>
